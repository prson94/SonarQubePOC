...
{
	public class WorkflowBaseJob : BaseWebJob
	{
		...
		public WorkflowBaseJob(IConfiguration config, ICachingProvider cache, IMailProvider mail, IQueueSource queue) : base(config)
		{
			Cache = cache;
			Mail = mail;
			Queue = queue;
