...
namespace d360.scheduler.jobs
{
    ...
    public class UpdateDatabaseTableStatisticsJob : BaseJob, IJob, IScheduledJob
    {
        ...
        public override string JobName { get { return "Update Database Table Statistics"; } }
        ...
        public void Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                if (StartJob())
                {
                    ...
                    Company.UpdateDatabaseTableStatistics();
        ...
        void RunForCompany(Company c)
        {
            ...
            try
            {
                ...
                companyCtx.UpdateDatabaseTableStatistics();
