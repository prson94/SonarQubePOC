...
namespace d360.scheduler.jobs
{
    ...
    public class RecalculateObjectHierarchiesJob : BaseJob, IJob, IScheduledJob
    {
        ...
        public override string JobName { get { return "Recalculate Object Hierarchies"; } }
        ...
        public void Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                if (StartJob())
                {
                    ...
                    Community.Companies.ToList().AsParallel().WithDegreeOfParallelism(4).ForAll(c =>
                    {
                        try
                        {
                            RunForCompany(c);
        ...
        void RunForCompany(Company c)
        {
            ...
            companyCtx.RecalculateObjectHierarchies();
