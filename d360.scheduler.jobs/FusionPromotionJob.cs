...
namespace d360.scheduler.jobs
{
    ...
    public class FusionPromotionJob : BaseJob, IJob, IScheduledJob
    {
        ...
        public override string JobName { get { return "Promote Fusion Attributes"; } }
        ...
        void RunForCompany(Company c)
        {
            ...
            try
            {
                ...
                try
                {
                    companyCtx.PromoteFusionAttributes();
                }
                catch (Exception ex)
                {
