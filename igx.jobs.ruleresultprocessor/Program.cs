...
outer apply (
			...
			from	AssetDetail O
					where O.[Object] = 'ReferenceItem' and QT.ResolutionFieldTypeID = 0 and QT.ResolutionFieldTypeName = 'Name' and QT.ResolutionObject = 'ReferenceItemType' and O.TypeID = QT.ResolutionObjectID and O.DisplayValue = Q.Value
			) R_R
outer apply (
			select	top 1
					'Taxonomy' as Object,
