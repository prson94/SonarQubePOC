...
BEGIN
	...
	WHEN 'Policy' THEN 'a/policy/' + CAST(@TypeID as varchar(15)) + '/' + CAST(@ObjectID as varchar(15))
	WHEN 'PolicyType' THEN 'a/policy/' + CAST(@TypeID as varchar(15))
	WHEN 'Resource' THEN 'a/resource/' + CAST(@ObjectID as varchar(15))
	WHEN 'ResourceType' THEN 'a/resource/list/' + CAST(@TypeID as varchar(15))
	WHEN 'Rule' THEN 'a/rule/' + CAST(@ObjectID as varchar(15))
