...
insert into #relations
	select
		...
		inod.IntersectTypeNodeID as StartIntersectTypeNodeID,
		...
		inod2.IntersectTypeNodeID as EndIntersectTypeNodeID,
	...
	begin
		...
		--start fusion id
		insert into dbo.fusionattributepromotion select r.StartFusionAttributeID as FusionAttributeID, 'Intersect', il.IntersectID,null  from #relations r inner join @IDLIst il on (r.ID = il.RelID)
		-- end fusion id
		insert into dbo.fusionattributepromotion select r.EndFusionAttributeID as FusionAttributeID, 'Intersect', il.IntersectID,null  from #relations r inner join @IDLIst il on (r.ID = il.RelID)
	end
