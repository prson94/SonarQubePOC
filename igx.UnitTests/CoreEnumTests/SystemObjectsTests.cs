...
namespace igx.UnitTests.CoreEnumTests
{
    ...
    public class SystemObjectsTests : BaseTest
    {
        ...
        {            
            ...
            Assert.True(SystemObjects.ConnectorLabel.ExcludeDataType() == (DataType.JSON | DataType.JsonElement | DataType.Path | DataType.ComplexRelationLookup | DataType.RefListRelationship | DataType.ReferenceList | DataType.FieldFromRelationship | DataType.OwnershipLookup | DataType.Relationship | DataType.Counter | DataType.System));
            ...
            Assert.True(SystemObjects.IssueTypeRelation.ExcludeDataType() == (DataType.FieldFromRelationship | DataType.OwnershipLookup | DataType.RefListRelationship | DataType.ReferenceList | DataType.ComplexRelationLookup | DataType.Relationship | DataType.JSON | DataType.JsonElement | DataType.Path | DataType.Tag | DataType.Score | DataType.Counter | DataType.System));
            ...
            Assert.True(SystemObjects.Task.ExcludeDataType() == (DataType.JSON | DataType.JsonElement | DataType.Path | DataType.ComplexRelationLookup | DataType.RefListRelationship | DataType.ReferenceList | DataType.FieldFromRelationship | DataType.OwnershipLookup | DataType.Relationship | DataType.Counter | DataType.System));
            Assert.True(SystemObjects.TaskType.ExcludeDataType() == (DataType.JSON | DataType.JsonElement | DataType.Path | DataType.ComplexRelationLookup | DataType.RefListRelationship | DataType.ReferenceList | DataType.FieldFromRelationship | DataType.OwnershipLookup | DataType.Relationship | DataType.Counter | DataType.System));
