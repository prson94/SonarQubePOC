...
namespace igx.UnitTests.RepositoryTests
{
	...
	public class AssetRepositoryTests : BaseTest
	{
		...
		public void GetAssetType()
		{
			...
			var assetRepository = new AssetRepository(mockCompanyContext.Object, GetSecurity(), GetQueue(), GetStorage(), GetCommunityContext(), GetFeatureFlagService());
		...
		public void GetAssets()
		{
			...
			mockCompanyContext.Setup(x => x.GetUserPermissionQuery(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
				.Returns("create table #PermissiondAssets");
