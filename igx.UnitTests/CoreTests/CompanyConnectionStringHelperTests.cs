...
namespace igx.UnitTests.CoreTests
{
    ...
    public class CompanyConnectionStringHelperTests : BaseTest
    {
        ...
        public void CheckBasicConnectionString()
        {
            ...
            string expectedResult = $"server=server.com;Database=D3S_5;User ID=user;Password=password;MultipleActiveResultSets=True;ConnectRetryCount=4;ConnectRetryInterval=5;Connection Timeout=20;Max Pool Size=2500;ApplicationIntent=ReadWrite;";
