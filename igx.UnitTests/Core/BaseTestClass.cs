...
"</settings>"}
        ...
        public IAssetRepository GetAssetRepository()
        {
            ...
            mockRepo.Setup(x => x.PostAssets(It.IsAny<List<AssetInsert>>(), It.IsAny<AssetType>(), It.IsAny<ApiExecution>(), true, true, false, false))
                .Returns((List<AssetInsert> assetInsertList, object o2, object o3, object o4, object o5, object o6, object o7) =>
                 {
            ...
            mockRepo.Setup(x => x.PutAssets(It.IsAny<List<AssetUpdate>>(), It.IsAny<AssetType>(), It.IsAny<ApiExecution>(), true, true, false, false))
                .Returns((List<AssetUpdate> assetUpdateList, object o2, object o3, object o4, object o5, object o6, object o7) =>
                {
        ...
        public IMetricsRepository GetMetricsRepository()
        {
            ...
            mock.Setup(x => x.GetMetricStructureFragments(It.IsAny<Guid>(),It.IsAny<List<State>>()))
                .Returns(new List<string>() {
                    @"[{""ID"":420,""Name"":""Name"",""Type"":""Text""},{""ID"":421,""Name"":""AssetDate"",""Type"":""Date""}]"
                });
