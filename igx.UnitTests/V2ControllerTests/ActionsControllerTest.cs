...
namespace igx.UnitTests.V2ControllerTests
{
	...
	public class ActionsControllerTest : BaseTest
	{
		...
		{
			actionsController = new ActionsController(GetCoreComponentSet(), GetCommentRepository(), GetIssueRepository(), GetAssetRepository(), GetResponsibilityRepository().Object, GetQueue())
			{
