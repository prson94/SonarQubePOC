...
{
    [Trait("Unit tests", "Scoring - Operators For Number Comparison")]
    public class OperatorTestsNumberCompares : BaseTest
    {
        string dataType = DataType.Number.ToString();
        string valueToCompare = "22";
        List<string> lesserValues = new List<string>() { "21" };
        List<string> equalValues = new List<string>() { "22" };
        List<string> greaterValues = new List<string>() { "23" };
        string falseFormatStatement = "The [Number] result of the [{0}] (with {1}) comparison is true, but it should be false.";
        string trueFormatStatement = "The [Number] result of the [{0}] (with {1}) comparison is false, but it should be true.";
