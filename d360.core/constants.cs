namespace d360.core
{
    public static class constants
    {
        ...
        public const string COMMUNITY_DATABASE_CONNECTION_FAILOVER = @"Server=tcp:d3smainwest.database.windows.net;Database=D3S;User ID=d3s_user;Password=FFhdit^WQgLKjeEwq017;Trusted_Connection=False;";
