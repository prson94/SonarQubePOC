namespace d360.core
{
    public static class CompanyConnectionStringHelper
    {
        ...
        private const int CONNECTION_RETRY_COUNT = 1;   // Default is 1. Range is 0 through 255.
        ...
        private const int CONNECTION_TIMEOUT = 15;  // Default is 15 seconds. Range is 0 through 2147483647, NEEDS TO BE AT LEAST  Connection Timeout = ConnectRetryCount * ConnectionRetryInterval
