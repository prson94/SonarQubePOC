namespace d360.core
{
    public static class CompanyConnectionStringHelper
    {
        ...
        private const int CONNECTION_RETRY_COUNT = 4;   // Default is 1. Range is 0 through 255.
        private const int CONNECTION_RETRY_INTERVAL = 5; //Default is 10 seconds. Range is 1 through 60.  https://docs.microsoft.com/en-us/dotnet/api/system.data.sqlclient.sqlconnectionstringbuilder.connectretryinterval?view=dotnet-plat-ext-3.1
        private const int CONNECTION_TIMEOUT = 20;  // Default is 15 seconds. Range is 0 through 2147483647, NEEDS TO BE AT LEAST  Connection Timeout = ConnectRetryCount * ConnectionRetryInterval
