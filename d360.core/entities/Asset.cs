...
namespace d360.core.entities
{
	...
	public class DynamicQueryJoins
	{
		...
		public void Merge(DynamicQueryJoins assetQuery)
		{
			foreach (var item in assetQuery.joins)
			{
				this.Add(item.SQLStatement, item.FieldIdentifier);
			}
		}

		public string SQLJoinStatement
		{
			get
			{
