...
namespace d360.core.entities
{
    ...
    public class IntersectFlowMappingItem : BaseIntObject, IIntObject, IUpdatedMetadata
    {
        #region Properties

        [DataMember]
        public int IntersectFlowMappingID { get; set; }
        ...
        public virtual IntersectFlowMapping IntersectFlowMapping { get; set; }
