...
namespace d360.core.entities
{
    ...
    {
        [DataMember, Key, Column(Order = 1), Display(ResourceType = typeof(d360.core.resources.Fields), Name = "AssetType_Name", Description = "AssetType_Description")]
        ...
        [IgnoreDataMember, ForeignKey("AssetTypeID"), Display(ResourceType = typeof(d360.core.resources.Fields), Name = "AssetType_Name", Description = "AssetType_Description")]
