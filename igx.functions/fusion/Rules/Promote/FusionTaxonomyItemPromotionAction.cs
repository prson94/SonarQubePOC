...
namespace igx.functions.fusion.Rules
{
    ...
    {        
        public FusionTaxonomyItemPromotionAction(FusionRuleStepModel step, TraceWriter log, int companyId, FusionRule rule, int promoteToObjectID, string promoteToObject)
        {
            Step = step;
            Log = log;
            CompanyId = companyId;
