...
namespace igx.functions.FusionProcessor
{
    public static class Engine
    {
        const string functionName = "FusionProcessor";

        [FunctionName(functionName)]
        public static void Run([QueueTrigger("d3s-bulkload", Connection = "DefaultEndpointsProtocol=https;AccountName=data3sixty;AccountKey=WoUrx1+4aeynNGuJkj/j6rKnszTbunJr2WQ3bJZQ/qU94YIn0zSQ0jRLFj5NN8pKKMY+QiBdGJcIqXyECf7oRA==;EndpointSuffix=core.windows.net")]string myQueueItem, TraceWriter log)
        {
