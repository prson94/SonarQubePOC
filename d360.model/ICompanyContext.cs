...
namespace d360.model
{
    public interface ICompanyContext : IBaseContext
    {
        ...
        List<BulkMetricTemporaryTableModel> BulkMetricsImport(BulkMetricsImport model, ApiExecution execution, ScoreType scoreType = ScoreType.Governance, bool validateAllocation = false);
