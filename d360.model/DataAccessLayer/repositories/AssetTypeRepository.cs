...
{
	public class AssetTypeRepository : DapperRepositoryBase<ICompanyDbConnectionProvider>, IAssetTypeRepository
	{
		public AssetTypeRepository(IDapperQueryComposer<ICompanyDbConnectionProvider> queryComposer) : base(queryComposer)
		{
		}
