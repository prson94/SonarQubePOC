...
namespace d360.model.DataAccessLayer
{
    public class AssetRepository : BaseRepository, IAssetRepository
    {
        ...
        readonly string AZURE_QUEUE_INSERTION_FAILURE_MESSAGE = "Internal occured error while submitting your batch request.Please try your request again. [Azure Queue Insertion Failure]";
