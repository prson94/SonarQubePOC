...
namespace d360.model.DataAccessLayer
{
    public interface IMembershipRepository
    {
        ...
        Task<IEnumerable<UserApiUpsertResult>> UpsertUsers(ApiExecution execution, IEnumerable<IUserApiUpsertModel> users, bool lookupFieldsPassedByValue = false, bool IsPwdChange = false);
