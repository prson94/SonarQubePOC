        ...
        public async Task BulkLoadAssets(Load load, IAssetRepository repository)
        {
            ...
            try
            {
                ...
                if (putAssets.Any())
                {
                    ...
                    ApiExecutionInfo executionInfo = await repository.PutBulkAssets(assetTypeUid, putAssets, execution, true);
                ...
                if (postAssets.Any())
                {
                    ...
                    ApiExecutionInfo executionInfo = await repository.PostBulkAssets(postAssets, execution, true);
