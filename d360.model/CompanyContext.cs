...
namespace d360.model
{
	...
	public partial class CompanyContext : BaseContext, ICompanyContext
	{
		...
		private void addQE(List<EventInfo> events, ChangeType action, EventObjectInfo item)
		{
			...
			{
				AssetType assetType = AssetTypes.FirstOrDefault(x => x.ID == item.AssetTypeID);
		...
		private void createEventsForObjectsRequiringTracking(IEnumerable<IEventTrackedEntity> modifiedEntities, IEnumerable<IEventTrackedEntity> addedEntities, IEnumerable<IEventTrackedEntity> deletedEntities, List<Field> changedFields)
		{
			...
			List<EventObjectInfo> fieldEvents = new List<EventObjectInfo>();
			...
			foreach (EventObjectInfo fieldEvent in fieldEvents)
			{
			...
			{
				foreach (IEventTrackedEntity modified in modifiedEntities)
				{
			...
			{
				foreach (IEventTrackedEntity added in addedEntities)
				{
			...
			{
				foreach (IEventTrackedEntity deleted in deletedEntities)
				{
		...
		{
			Set<T>().Add(item);
			bool returnValue = SaveChanges() > 0;
		...
		public IntersectDetail AddIntersect(int intersectTypeID, string subject, int subjectID, string @object, int objectID)
		{
			...
			ObjectDetail subjectDetail = GetObjectDetail(subject, subjectID);
			ObjectDetail objectDetail = GetObjectDetail(@object, objectID);
...
from	Field F
		...
		public void CreateOrUpdateTypeDisplayValuesAsync(int objectTypeId, string objectType)
		{
			...
			SiteNav navSiteItem = SiteNav.FirstOrDefault(x => x.Object == objectType && x.ObjectID == objectTypeId && x.ParentID != null);

			if (navSiteItem != null)
			{
				string assetTypeName = AssetTypes.FirstOrDefault(x => x.Object == objectType && x.ObjectID == objectTypeId)?.Name;
		...
		public async Task DeleteAsync<T>(Expression<Func<T, bool>> predicate) where T : BaseObject
		{
			try
			{
				List<T> items = await Filter(predicate).ToListAsync();
		...
		{
			Intersect item = GetById<Intersect>(id);
		...
		{
			IEnumerable<string> jsonStrings = await QueryAsync<string>(query, dbArgs, timeout).ConfigureAwait(false);
			string json = string.Join("", jsonStrings);

			json = "{\r\n  \"pageSize\": 25,\r\n  \"pageNum\": 1,\r\n  \"total\": 37,\r\n  \"items\": [\r\n    {\r\n      \"Name\": \"Name\",\r\n      \"FriendlyName\": \"Name\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 1,\r\n          \"SortOrder\": 1,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"IsRequired\": true\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": true,\r\n          \"IsPartOfKey\": true,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Properties\",\r\n      \"FriendlyName\": \"Properties\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Json\": {\r\n          \"ColumnOrder\": 2,\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"Validation\": {\r\n            \"IsRequired\": false\r\n          },\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Tag\",\r\n      \"FriendlyName\": \"Tag\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Tag\": {\r\n          \"ColumnOrder\": 3,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": true\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Description\",\r\n      \"FriendlyName\": \"Description\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 4,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": true,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"ProductType\",\r\n      \"FriendlyName\": \"ProductType\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 5,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"ProductName\",\r\n      \"FriendlyName\": \"ProductName\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 6,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"TimeZone\",\r\n      \"FriendlyName\": \"TimeZone\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 7,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"ReportServerRelativeUrl\",\r\n      \"FriendlyName\": \"ReportServerRelativeUrl\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 8,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"WebPortalRelativeUrl\",\r\n      \"FriendlyName\": \"WebPortalRelativeUrl\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 9,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"ReportServerAbsoluteUrl\",\r\n      \"FriendlyName\": \"ReportServerAbsoluteUrl\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 10,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"ProductVersion\",\r\n      \"FriendlyName\": \"ProductVersion\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 11,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": false,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"AlternativeHostNames\",\r\n      \"FriendlyName\": \"Alternative Host Names\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"Text\": {\r\n          \"ColumnOrder\": 12,\r\n          \"SortOrder\": 0,\r\n          \"SortByAscending\": true,\r\n          \"Description\": {\r\n            \"Display\": \"A comma-delimited list of alternative names/ aliases for the host asset.\",\r\n            \"Form\": \"A comma-delimited list of alternative names/ aliases for the host asset.\"\r\n          },\r\n          \"Validation\": {\r\n            \"MinimumLength\": 0,\r\n            \"IsRequired\": false\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"IsEditable\": true,\r\n          \"IsListable\": false,\r\n          \"IsPartOfKey\": false,\r\n          \"IsPrimaryFilter\": false,\r\n          \"ShowIfEmpty\": false,\r\n          \"Search\": {\r\n            \"AddToResult\": false\r\n          }\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"DB\",\r\n      \"FriendlyName\": \"DB\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 13,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"1BAF160F-CAC1-48EC-A054-9B798ED4DC88\",\r\n                \"AssetTypeUid\": \"2960C3B3-4FC2-4FC2-A128-439AFD06D33F\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"2960C3B3-4FC2-4FC2-A128-439AFD06D33F\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"SSISFolder\",\r\n      \"FriendlyName\": \"SSIS Folder\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 14,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"12E7B7C1-B71A-4878-BB62-8D53A5966A78\",\r\n                \"AssetTypeUid\": \"051C04F3-FC49-4600-9292-7A2123317296\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"051C04F3-FC49-4600-9292-7A2123317296\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"SSASModel\",\r\n      \"FriendlyName\": \"SSAS Model\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 15,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"C72FD3C7-911F-4484-8F23-43B1A66C26FC\",\r\n                \"AssetTypeUid\": \"ADB26B23-98B7-4F5C-8B0D-D17F471CE7D1\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"ADB26B23-98B7-4F5C-8B0D-D17F471CE7D1\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"SSRSReportFolder\",\r\n      \"FriendlyName\": \"SSRS Report Folder\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 16,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"B35E31B1-8682-43E3-83CE-69ABFBC834F9\",\r\n                \"AssetTypeUid\": \"8406AFD8-123C-47CD-8C7B-62031D228AA3\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"8406AFD8-123C-47CD-8C7B-62031D228AA3\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"PowerBIReportFolder\",\r\n      \"FriendlyName\": \"PowerBI Report Folder\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 17,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"9D2552D1-00F9-4D3C-8925-B2DF594016A4\",\r\n                \"AssetTypeUid\": \"B802F401-8505-48CF-97A8-505FBE8E1E22\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"B802F401-8505-48CF-97A8-505FBE8E1E22\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"MarkitFile\",\r\n      \"FriendlyName\": \"Markit File\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 18,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"72949948-EECE-4E74-9144-2996402EFCA1\",\r\n                \"AssetTypeUid\": \"AAE41DCB-465A-4E18-95E1-93AA60B7174C\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"AAE41DCB-465A-4E18-95E1-93AA60B7174C\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"MarkitIllustration\",\r\n      \"FriendlyName\": \"Markit Illustration\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 19,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"5AD5E2FC-84D2-49DC-B0E9-3D66A8DE0100\",\r\n                \"AssetTypeUid\": \"18C7F670-62E7-4DAA-9A94-B82F417144BD\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"18C7F670-62E7-4DAA-9A94-B82F417144BD\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"MarkitProcess\",\r\n      \"FriendlyName\": \"Markit Process\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 20,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"278461BC-8C7A-4C37-8A05-8CD2ED50547B\",\r\n                \"AssetTypeUid\": \"F5FE0009-A6DA-4EC9-8588-B9AF092A86C1\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"F5FE0009-A6DA-4EC9-8588-B9AF092A86C1\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Function\",\r\n      \"FriendlyName\": \"Function\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 21,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"0F67EB23-B8BF-4B93-A224-697C69D247B3\",\r\n                \"AssetTypeUid\": \"F147A50E-0BCD-4AC4-9CD1-52649FDF9464\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"F147A50E-0BCD-4AC4-9CD1-52649FDF9464\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"FunctionorProcedure\",\r\n      \"FriendlyName\": \"Function or Procedure\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 22,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"5CBEB691-7E92-4974-BB57-A5D1FC4C1441\",\r\n                \"AssetTypeUid\": \"72509BEA-BF9C-4268-A291-B44E2995988B\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"72509BEA-BF9C-4268-A291-B44E2995988B\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Schema\",\r\n      \"FriendlyName\": \"Schema\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 23,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"31F18B48-4907-4C67-B25A-EF5442462507\",\r\n                \"AssetTypeUid\": \"64C76949-9A3D-4946-BBC0-26E83441E213\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"64C76949-9A3D-4946-BBC0-26E83441E213\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Table\",\r\n      \"FriendlyName\": \"Table\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 24,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"FFEE508E-97DE-4AA3-9F6F-D8563A6047EB\",\r\n                \"AssetTypeUid\": \"C0D411A8-BFE2-42D0-A550-D9DC47C2E334\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"C0D411A8-BFE2-42D0-A550-D9DC47C2E334\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    },\r\n    {\r\n      \"Name\": \"Trigger\",\r\n      \"FriendlyName\": \"Trigger\",\r\n      \"AssetTypeUid\": \"379D00AF-AD89-4F19-A3CD-CFE47294A19B\",\r\n      \"Type\": {\r\n        \"ComputedRelationshipLookup\": {\r\n          \"ColumnOrder\": 25,\r\n          \"Description\": {\r\n            \"Display\": \"string\"\r\n          },\r\n          \"HideHeader\": false,\r\n          \"HideFooter\": false,\r\n          \"HideFilter\": false,\r\n          \"LookupType\": 0,\r\n          \"Definition\": {\r\n            \"Relations\": [\r\n              {\r\n                \"IntersectTypeUid\": \"3231525B-A737-49D2-B396-79A1DD801939\",\r\n                \"AssetTypeUid\": \"1E1D1EF6-2A76-462E-A201-4CA48BB91B31\",\r\n                \"RelationType\": 3,\r\n                \"Direction\": 2\r\n              }\r\n            ],\r\n            \"Fields\": [\r\n              {\r\n                \"AssetTypeUid\": \"1E1D1EF6-2A76-462E-A201-4CA48BB91B31\",\r\n                \"FieldTypeName\": \"Name\",\r\n                \"DisplayOrder\": 1,\r\n                \"SortOrder\": 0,\r\n                \"Show\": true,\r\n                \"Width\": 0,\r\n                \"RelationIndex\": 0\r\n              }\r\n            ]\r\n          },\r\n          \"IsDisplayable\": true,\r\n          \"ShowIfEmpty\": false\r\n        }\r\n      }\r\n    }\r\n  ]\r\n}";
		...
		public void GetDynamicFieldJoinStatements(int typeID, string type, out string joins, out string columns, bool includeIdColumn = true, bool useFriendlyName = false, bool listableOnly = true, List<FieldType> fields = null, string idColumn = "A.ID", bool ruleMeansEvent = true, bool enableRelationshipFields = true, bool includeKeyColumnOnly = false)
		{
			...
			{
				string name = $"Field{f.ID}";
				string friendlyName = f.FriendlyName.Replace("[", "").Replace("]", "");
				...
				else if (f.Type == DataType.FieldFromRelationship.ToString())
				{
					if (enableRelationshipFields)
					{
						...
						if (relationFieldInfo != null)
						{
							FieldType relationshipLookupFieldType = GetById<FieldType>(f.LookupObjectFieldTypeID ?? 0);
				...
				else if (f.Type == DataType.JsonElement.ToString())
				{
					...
					string sqlType = DetermineSqlDataTypeForFieldType(f);
		...
		public string GetIntersectTypeName(IntersectType intersectType)
		{
			...
			string itName = Query<string>(sql, new { id = intersectType.ID }).FirstOrDefault();
...
from	IntersectType I
		...
		{
			List<PredicateTypeInfo> allowedFunctionalTypes = PredicateType.Simple.GetAsList().Where(p =>
			...
			bool isSubjectIntersectType = IntersectTypes.Any(i => i.uid == subjectUid);
			...
			PredicateType[] allowedTypes = allowedFunctionalTypes.Select(p => p.ID).ToArray();
			IQueryable<Predicate> predicates = Predicates.Where(i => allowedTypes.Contains(i.Type));
		...
		public List<RelationshipDirectionFieldInfo> GetRelationFieldData(int assetTypeId, List<FieldType> fields)
		{
			...
			if (relationshipFields != null)
			{
				...
				{
					List<int> intersectTypeIDs = relationshipFields.Select(i => i.LookupObjectID.Value).ToList();
					List<IntersectType> intersectTypes = Filter<IntersectType>(i => intersectTypeIDs.Contains(i.ID)).ToList();
					foreach (FieldType rF in relationshipFields)
					{
						RelationshipDirectionFieldInfo relationFieldInfo = new RelationshipDirectionFieldInfo { FieldTypeID = rF.ID, IntersectTypeID = rF.LookupObjectID.Value };
						IntersectType intersectType = intersectTypes.SingleOrDefault(i => i.ID == relationFieldInfo.IntersectTypeID);
		...
		public Dictionary<string, object> GetRelationshipFieldItems(int fieldTypeID, long assetId, int offset = 0, int rows = 25, string query = null, bool includeSelection = true, IntersectType intersectType = null, FieldType ft = null, bool onlyQueries = false)
		{
			...
			{
				count = Database.Connection.QueryFirstOrDefault<int>(countSql, new { assetId, query, intersectTypeID = intersectType.ID, objectAssetTypeID });
			}
		...
		public bool LookupFieldHasColorItem(FieldType fieldType)
		{
			...
			{
				string obj = fieldType.LookupObjectType == "ReferenceItem" ? "ReferenceItemType" : fieldType.LookupObjectType;
				...
				AssetType assettype = AssetTypes.FirstOrDefault(x => x.Object == obj && x.ObjectID == fieldType.LookupObjectID);
		...
		public void ParseAdvancedFilterQueryParameter(IEnumerable<KeyValuePair<string, string>> queryParams, List<DefaultFilter> fieldList, out DynamicParameters dbArgs, out List<string> whereStatements)
		{
			...
			if (queryParams.Any(x => x.Key.Equals("_filter", StringComparison.OrdinalIgnoreCase)))
			{
				...
				{
					FilterDataProvider filterDataProvider = new FilterDataProvider(this);
		...
		public void ParseSimpleFilterQueryParameter(IEnumerable<KeyValuePair<string, string>> queryParams, List<DefaultFilter> fieldList, out DynamicParameters dbArgs, out List<string> whereStatements)
		{
			...
			DynamicParameters dbs = new DynamicParameters();
					...
					fieldList.ForEach(f =>
					{
						switch (f.SqlFieldType)
						{
							...
							case SqlFieldType.Number:
								...
								{
									int places = filterNumber.GetNumberOfDecimalPlaces();
									decimal ceil = decimal.Round(decimal.Parse(value + "9"), places);
		...
		public override int SaveChanges()
		{
			...
			foreach (ObjectStateEntry entry in ObjectContext.ObjectStateManager.GetObjectStateEntries(EntityState.Added))
			{
				...
				{
					IUIDMetadata o = entry.Entity as IUIDMetadata;
					o.UID = Guid.NewGuid();
				}
			...
			foreach (ObjectStateEntry entry in ObjectContext.ObjectStateManager.GetObjectStateEntries(EntityState.Added | EntityState.Modified | EntityState.Deleted))
			{
				...
				{
					Field field = (Field)entry.Entity;
				...
				{
					IntersectType o = entry.Entity as IntersectType;
					int id = o.ID;
					...
					{
						o.uid = Guid.NewGuid();
						string addCheck = Query<string>(sql).SingleOrDefault();
					...
					{
						string updateCheck = Query<string>(sql).SingleOrDefault();
				...
				{
					Report o = entry.Entity as Report;
				...
				{
					ResponsibilityType o = entry.Entity as ResponsibilityType;
			...
			List<IEventTrackedEntity> modifiedEventEntities = ChangeTracker.Entries<IEventTrackedEntity>()
			   .Where(p => p.State == EntityState.Modified)
			   .Select(p => p.Entity).ToList();

			List<IEventTrackedEntity> addedEventEntities = ChangeTracker.Entries<IEventTrackedEntity>()
				.Where(p => p.State == EntityState.Added)
				.Select(p => p.Entity).ToList();

			List<IEventTrackedEntity> deletedEventEntities = ChangeTracker.Entries<IEventTrackedEntity>()
		...
		{
			bool isUpdate = forceUpdate || IsPersistent(entity);
...
from	IntersectType I
		...
		{
			Predicate predicateModel = GetById<Predicate>(model.PredicateID.Value);
