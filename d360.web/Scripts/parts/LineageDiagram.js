function LineageDiagramWrapper(w) {
    ...
    function unsubscribe(){
        $('#LineageWindowTabs').jqxTabs('destroy');
        $('#LineageWindow').jqxWindow('destroy');
    ...
    $(function () {
        ...
        var windowSettings = {
            height: 'auto', width: 500, position: 'center, right',
            draggable: true,
            autoOpen: true,
            zIndex: 1002,
        ...
        $('#LineageWindow').jqxWindow(windowSettings);

        $('#LineageWindowTabs').jqxTabs({theme: 'metro', width: '100%', scrollable:false});//, height: '100%'
        ...
        $('#LineageTools').on('itemclick', function(event){
            ...
            switch($(li).data('action')) {
                ...
                case 'openwindow':
                    //#region
                    $("#LineageWindow").jqxWindow('open');
                    $("#LineageWindow").jqxWindow('move', offset.left - 100, offset.top + 100);
                    break;
                    //#endregion
                case 'close':
                    //#region
        ...
        //must be here, after grids are instantiated
        $('#LineageWindow').on('resized', function (event) { 
            $('#Lineage_mappingrules_content').jqxGrid('refresh');
            $('#Lineage_responsibilities_content').jqxGrid('refresh');
            $('#Lineage_fusion_content').jqxGrid('refresh');
        }); 
                    ...
                    try {
                        if (lineageObject && lineageObjectID && data.obj && data.objid) {
                            $.ajax({
                                ...
                                console.log(sourceTemplate(data));
        ...
        function toggleButtons(data) {
            if (data == null) {
                $('#LineageWindowTabs').jqxTabs('disableAt', 0); //$('#LineageTools').jqxMenu('disable', 'w_info', true);
                $('#LineageWindowTabs').jqxTabs('disableAt', 1); //$('#LineageTools').jqxMenu('disable', 'w_sourcerules', true);
                $('#LineageWindowTabs').jqxTabs('disableAt', 2); //$('#LineageTools').jqxMenu('disable', 'w_mappings', true);
                $('#LineageWindowTabs').jqxTabs('disableAt', 3); //$('#LineageTools').jqxMenu('disable', 'w_roles', true);
                $('#LineageWindowTabs').jqxTabs('disableAt', 4); //$('#LineageTools').jqxMenu('disable', 'w_fusion', true);
                ...
                if (data.diagramObjectType == 'Node') {
                    $('#LineageWindowTabs').jqxTabs('enableAt', 0); //$('#LineageTools').jqxMenu('disable', 'w_info', false);
                    $('#LineageWindowTabs').jqxTabs('enableAt', 1); //$('#LineageTools').jqxMenu('disable', 'w_sourcerules', false);
                    $('#LineageWindowTabs').jqxTabs('disableAt', 2); //$('#LineageTools').jqxMenu('disable', 'w_mappings', true);
                    $('#LineageWindowTabs').jqxTabs('enableAt', 3); //$('#LineageTools').jqxMenu('disable', 'w_roles', false);
                    $('#LineageWindowTabs').jqxTabs('enableAt', 4); //$('#LineageTools').jqxMenu('disable', 'w_fusion', false);
                    ...
                    $('#LineageWindowTabs').jqxTabs('disableAt', 0); //$('#LineageTools').jqxMenu('disable', 'w_info', true);
                    $('#LineageWindowTabs').jqxTabs('disableAt', 1); //$('#LineageTools').jqxMenu('disable', 'w_sourcerules', true);
                    $('#LineageWindowTabs').jqxTabs('enableAt', 2); //$('#LineageTools').jqxMenu('disable', 'w_mappings', false);
                    $('#LineageWindowTabs').jqxTabs('disableAt', 3); //$('#LineageTools').jqxMenu('disable', 'w_roles', true);
                    $('#LineageWindowTabs').jqxTabs('disableAt', 4); //$('#LineageTools').jqxMenu('disable', 'w_fusion', true);
        ...
        function populateDiagram() {
            ...
            var results = $.ajax({
                ...
                amplify.publish("ShowMessage", { title: "Error while reloading", message: errorThrown, type: 'error' });
...
function LineageCloseWindow() {
    $('#LineageWindow').jqxWindow('close');
}