...
import { HelpMenuService } from '../../components/shared/helpmenu/helpmenu.service';
import { HelpMenu } from '../../models/helpmenu.model';
import { DynamicButton } from '../../models/secondaryNav.model';
import { CompanySettings, SearchType, CompanyImage, CompanyRebuildJobStatusApiModel, CompanySettingEnum, SettingsHelper, SettingsPutModel, CompanyRebuildJobStatusState } from '../../models/settings.model';
...
import { IpRestrictions } from './components/ip-restrictions';
import { SiteMenuConfiguration } from './components/site-menu-configuration';
...
export class SettingsIndex extends AdminBaseComponent {
    items: HelpMenu[] = []; 
    ...
    save(): void {
        ...
        settings.push({
            SettingID: CompanySettingEnum.EmailDomainWhitelist,
            StringSetting: { Value: this.companySettings.EmailDomainWhitelist },
            BooleanSetting: null, GuidSetting: null, IpAddressSetting: null, NumberSetting: null
        });
        settings.push({
