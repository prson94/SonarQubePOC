...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__group_routes__ = __webpack_require__(1451);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__group_component__ = __webpack_require__(1333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__group_item_component__ = __webpack_require__(1331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__group_list_component__ = __webpack_require__(1332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__group_responsibility_component__ = __webpack_require__(1450);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_primeng_primeng__ = __webpack_require__(114);
...
/* harmony export (binding) */ __webpack_require__.d(exports, "GroupModule", function() { return GroupModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    GroupModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                ...
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["e" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["RouterModule"],
                __WEBPACK_IMPORTED_MODULE_11__group_routes__["a" /* GroupRoutingModule */],
                //primeng
                __WEBPACK_IMPORTED_MODULE_16_primeng_primeng__["GrowlModule"],
                __WEBPACK_IMPORTED_MODULE_16_primeng_primeng__["DataTableModule"],
                __WEBPACK_IMPORTED_MODULE_16_primeng_primeng__["SharedModule"],
                //d3s
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_12__group_component__["a" /* GroupComponent */],
                __WEBPACK_IMPORTED_MODULE_13__group_item_component__["a" /* GroupItemComponent */],
                __WEBPACK_IMPORTED_MODULE_14__group_list_component__["a" /* GroupListComponent */],
                __WEBPACK_IMPORTED_MODULE_15__group_responsibility_component__["a" /* GroupResponsibilityComponent */],
            ],
            providers: [
                { provide: __WEBPACK_IMPORTED_MODULE_3__angular_http__["d" /* XHRBackend */], useClass: __WEBPACK_IMPORTED_MODULE_5__authentication_connection_backend__["a" /* AuthenticationConnectionBackend */] },
            ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__ = __webpack_require__(484);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__ = __webpack_require__(85);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return GroupItemComponent; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var GroupItemComponent = (function (_super) {
    __extends(GroupItemComponent, _super);
    function GroupItemComponent(route, router, groupService, titleService, headerBreadcrumbService) {
        _super.call(this);
        this.route = route;
        this.router = router;
        this.groupService = groupService;
    ...
    GroupItemComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.params.subscribe(function (params) {
            _this.groupId = +params['groupId']; // (+) converts string 'id' to a number
            _this.headerBreadcrumbService.setCurrentObjectInfo('Group', _this.groupId);
            _this.logAction('open', 'Group', _this.groupId);
            _this.isLoading = true;
            _this.groupService.getGroup(_this.groupId)
                .then(function (group) {
                _this.model = group;
                _this.headerBreadcrumbService.clearBreadcrumbs();
                _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */]('Groups', __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_GROUP_ROOT));
                _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](_this.model.group.Name));
                _this.setBrowserTitle(_this.titleService, _this.model.group.Name);
                _this.isLoading = false;
            });
        });
    };
    GroupItemComponent.prototype.ngOnDestroy = function () {
        this.sub.unsubscribe();
        this.clearSidebar();
    };
    GroupItemComponent.prototype.load = function () {
    };
    GroupItemComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'd3s-group-item',
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_index__["R" /* GroupService */]],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["R" /* GroupService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["R" /* GroupService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */]) === 'function' && _e) || Object])
    ], GroupItemComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__ = __webpack_require__(484);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__ = __webpack_require__(85);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return GroupListComponent; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var GroupListComponent = (function (_super) {
    ...
    function GroupListComponent(route, router, groupService, titleService, headerBreadcrumbService) {
        _super.call(this);
        this.route = route;
        this.router = router;
        this.groupService = groupService;
    ...
    GroupListComponent.prototype.ngOnInit = function () {
        ...
        this.headerBreadcrumbService.clearBreadcrumbs();
        this.headerBreadcrumbService.clearCurrentObjectInfo();
        this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */]('Groups'));
        this.load();
    };
    GroupListComponent.prototype.groupUrl = function (id) {
        return __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_GROUP_ROOT + '/' + id;
    };
    GroupListComponent.prototype.load = function () {
        var _this = this;
        this.isLoading = true;
    ...
    GroupListComponent.prototype.showGroup = function (group) {
        if (!group) {
            console.log("ERROR : NO GROUP SELECTED TO NAVIGATE TO.");
            return;
        }
        this.router.navigateByUrl(__WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('Group', group.ID));
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_index__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_group_model__ = __webpack_require__(1220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_base_component__ = __webpack_require__(113);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return GroupResponsibilityComponent; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var GroupResponsibilityComponent = (function (_super) {
    __extends(GroupResponsibilityComponent, _super);
    function GroupResponsibilityComponent(groupService) {
        _super.call(this);
        this.groupService = groupService;
        this.group = null;
        this.items = new Array();
    ...
    GroupResponsibilityComponent.prototype.ngOnChanges = function (changes) {
        if (changes['group'] && this.group)
            this.load();
    };
    GroupResponsibilityComponent.prototype.isSelected = function (item) {
        return (item == this.selected);
    };
    GroupResponsibilityComponent.prototype.select = function (item) {
        this.selected = item;
    };
    GroupResponsibilityComponent.prototype.load = function () {
        var _this = this;
        this.isLoading = true;
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__models_group_model__["d" /* Group */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__models_group_model__["d" /* Group */]) === 'function' && _a) || Object)
    ], GroupResponsibilityComponent.prototype, "group", void 0);
    GroupResponsibilityComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__services_index__["R" /* GroupService */], __WEBPACK_IMPORTED_MODULE_1__services_index__["e" /* ResourcesService */]]
        }), 
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__services_index__["R" /* GroupService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__services_index__["R" /* GroupService */]) === 'function' && _b) || Object])
    ], GroupResponsibilityComponent);
    return GroupResponsibilityComponent;
    var _a, _b;
}(__WEBPACK_IMPORTED_MODULE_3__shared_base_component__["a" /* BaseComponent */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__group_component__ = __webpack_require__(1333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__group_item_component__ = __webpack_require__(1331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__group_list_component__ = __webpack_require__(1332);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return GroupRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__group_component__["a" /* GroupComponent */],
        children: [
            { path: ':groupId', component: __WEBPACK_IMPORTED_MODULE_3__group_item_component__["a" /* GroupItemComponent */] },
            { path: '', component: __WEBPACK_IMPORTED_MODULE_4__group_list_component__["a" /* GroupListComponent */] }
        ]
    }
];
...
//# sourceMappingURL=groupChunk.map