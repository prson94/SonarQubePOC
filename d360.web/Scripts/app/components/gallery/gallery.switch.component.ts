...
export class GallerySwitchComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.properties.push({ Name: "optional", Type: "boolean", Description: "Determines if the control allows the switch control to return to the unselected state.", Default: "false" });
