        ...
        <div class="tile tile-detail" style="position:initial">
            ...
            <span *ngIf="!isLoading && !showEditor">
                        ...
                        <p-table #dt
                                 ...
                                 (selectionChange)="fusionAttribute=$event;fusionAttributeChange.emit(fusionAttribute);"
                                 (onLazyLoad)="loadFusionAttributesLazy($event)"
        ...
        if (changes['fusionAttributeTypeId'] && this.fusionAttributeTypeId) {
            ...
            if (this.initialFusionAttributeId > 0)
                this.stateService.getFusionFilter(this.isDataProfile).filters = [{
                    dataField: 'ID',
                    value: this.initialFusionAttributeId.toString(),
                    condition: 'CONTAINS',
                    columnType: ''
                }];
