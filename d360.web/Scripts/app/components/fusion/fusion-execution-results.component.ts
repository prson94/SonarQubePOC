...
@Component({
    ...
    template: `     
                    ...
                    <p-table #dt [value]="results" [loading]="isLoading" loadingIcon="fa fa-spinner" selectionMode="single" [metaKeySelection]="true" [globalFilterFields]="['FusionAttributeType','FusionAttribute','Action','FieldName','OldValue','NewValue']" 
                        [pageLinks]="3" [paginator]="true" [rows]="5" [rowsPerPageOptions]="[5,10,20]" [(selection)]="selected" (onLazyLoad)="loadResultsLazy($event)" lazy="true" [totalRecords]="resultCount"
                        [scrollable]="true">
