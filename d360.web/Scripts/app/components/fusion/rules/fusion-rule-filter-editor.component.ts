...
import { FusionRuleFilter, FusionRuleFilterEditorModel, FusionRuleFilterItem, FusionRule, AttributeNode } from '../../../models/fusion.model';
    ...
    <div *ngIf="!isLoading">
        ...
        <div class="row" style="margin-top: 20px">
            <div class="col l6 m6 s12">
                ...
                <div class="form-instructions">Choose one or more fields below to act as filters for the set of attributes you want to apply the rule to. If you want to use all items of this type, please select the All Items checkbox above.</div>
                <table class="striped highlight responsive-table">
                    <thead>
                        <tr>
                            ...
                            <th>Condition</th>
                            <th>Value</th>
                            <th><button type="button" class="WhiteButton" (click)="addFilterItem()" [disabled]="model.All"><i class="fa fa-plus" title="Add filter field"></i></button></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr *ngFor="let fld of model.Items">
                            <td>
                                <select [disabled]="model.All" [(ngModel)]="fld.FieldTypeID" (change)="onFieldTypeChange(fld)">
                                    <option *ngFor="let item of model.FieldTypes" [value]="item.ID">{{ item.Name }}</option>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <input [disabled]="model.All" *ngIf="fld.Type == 'Boolean'" type="checkbox" [(ngModel)]="fld.Value" />
                                <input [disabled]="model.All" *ngIf="fld.Type == 'Text'" type="text" [(ngModel)]="fld.Value" />
                            </td>
                            <td>
                                <button type="button" [disabled]="model.All" class="WhiteButton" (click)="deleteFilterItem(fld)">
...
export class FusionRuleFilterEditorComponent extends BaseComponent implements OnInit {
    ...
    load() {
        ...
        if (this.fusionRuleFilterID == null) {
            //This is an ADD
            this.fusionService.getAddFusionRuleFilter(this.fusionRule.ID)
                .then(r => {
                    this.model = r;
            ...
            //This is an EDIT
            this.fusionService.getEditFusionRuleFilter(this.fusionRuleFilterID)
                .then(r => {
                    this.model = r;
                })
                .then(() => this.isLoading = false);
    ...
    onFieldTypeChange(ft) {
        let selectedFieldType = this.model.FieldTypes.find(o => { return o.ID == ft.FieldTypeID });
    ...
    getTestResults() {
        ...
        this.fusionService
            ...
            .then(() => this.QueryExecuting = false)
    ...
    save() {
        ...
        if (this.fusionRuleFilterID == null) {
            //This is an ADD
            this.fusionService.postAddFusionRuleFilter(this.model)
                .then(r => {
            ...
            //This is an EDIT
            this.fusionService.putEditFusionRuleFilter(this.model)
                .then(r => {
                    this.showMessageForResult(this.messagesService, r);
                    this.isLoading = false;
                    this.onSave.emit();
