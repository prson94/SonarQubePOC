    ...
    template: `
               <header *ngIf="!showEditor && !showDelete">Invitations for this organization
                ...
                <span *ngIf="!isLoading && !showDelete && !showEditor">
                    ...
                    <p-table #dt [value]="invitations" selectionMode="single" [metaKeySelection]="true" [globalFilterFields]="['Email']" [pageLinks]="3" [paginator]="true" [rows]="defaultInitialItemsPerPage" [rowsPerPageOptions]="defaultPagingOptions" [(selection)]="selected">
