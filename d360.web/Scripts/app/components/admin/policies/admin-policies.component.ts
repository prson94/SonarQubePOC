                    ...
                    <div class="col l4 s12">                    
                        <div class="tile tile-detail">
                            ...
                            <span *ngIf="!isLoading && !showEditor && !showDelete">
                                ...
                                <p-table #dt [value]="policyTypes" selectionMode="single" [metaKeySelection]="true" [globalFilterFields]="['Name','MaximumDepth']" sortField="Name" [sortOrder]="1" [pageLinks]="3" [paginator]="true" [rows]="20" [(selection)]="selected">
