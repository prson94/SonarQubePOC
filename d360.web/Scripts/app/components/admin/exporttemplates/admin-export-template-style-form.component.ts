...
@Component({
    ...
    template: `
    <header>{{mode}} <ng-container i18n>Styling Rules</ng-container></header>
    <div class="clear"></div>
        ...
        <form #styleForm="ngForm" (ngSubmit)="save()">
            <div class="row">
                <div class="col l6 m6 s12">
                    <div class="FieldName" i18n>Selection</div>
                    <div class="row">
                        <div class="col s12">
            ...
            <div class="row">
                <div class="col l6 m6 s12">
                    <div class="FieldName">{{model.SelectionType}} <ng-container i18n>Number</ng-container></div>
                    <div class="row">
                        <div class="col s12">
                ...
                <div class="col l6 m6 s12">
                    <div class="FieldName" i18n>Text Color</div>
                    <div class="row">
                        <div class="col s12">
            ...
            <div class="row">
                <div class="col l6 offset-l6 m6 offset-m6 s12">
                    <div class="FieldName" i18n>Bold Text</div>
                    <div class="row">
                        <div class="col s12">
            ...
            <div class="row">
                <div class="col s12 buttons">
                    <button igButton type="submit" class="ig-button-primary" margin label="{{labelSave}}" [disabled]="!styleForm.form.valid"></button>
                    <button igButton type="button" class="ig-button-secondary" label="{{labelCancel}}" (click)="onCancel.emit(null)"></button>
                </div>
            </div>
        </form>
    </div>
