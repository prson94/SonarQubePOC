...
@Component({
    ...
    template: ` 
               ...
               <div *ngIf="!isLoading">
                   ...
                   <d3s-modal [title]="'Create Measure'" additionalClasses="large-dialog" (onClose)="formMode = FormMode.Default;" (onSave)="formMode = FormMode.Default; load(); " [isVisible]="formMode == FormMode.Adding">
                   ...
                   <d3s-modal [title]="'Edit Measure'" additionalClasses="large-dialog" (onClose)="formMode = FormMode.Default;" (onSave)="formMode = FormMode.Default; load(); " [isVisible]="formMode == FormMode.Editing">
