...
@Component({
    selector: "d3s-configuration-asset-type-relationships-page",
    templateUrl: './configuration-asset-type-relationships-page.component.html'
})
export class ConfigurationAssetTypeRelationshipsPageComponent {
