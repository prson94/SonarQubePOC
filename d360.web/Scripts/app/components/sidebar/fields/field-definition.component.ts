            ...
            <div class="row" *ngIf="!isLoading">
                <div class="col s12">
                    <div class="tile tile-detail">  
                        <d3s-field-definition-tile [objectID]="objectID" [objectType]="objectType" [title]="objectName"></d3s-field-definition-tile>
                    </div>
                </div>
            </div>
        `,
    ...
    ngOnInit() {
        this.sub = this.route.params.subscribe(params => {
            ...
            this.objectDetailService.getObject(this.objectID, this.objectType).then(res => {
                if (res) this.objectName = 'Field Definitions for ' + (res.Name ? res.Name : res.DisplayValue);
            });
        });        
    }
