                    ...
                    <div class="col s12 m12 l6">                                      
                        <div class="tile tile-detail">                            
                            ...
                            <span *ngIf="!isDetailsLoading">
                                ...
                                <p-dataTable [globalFilter]="gb" #dt [rows]="defaultInitialItemsPerPage" paginator="true" pageLinks="3" [rowsPerPageOptions]="defaultPagingOptions" [(selection)]="selectedWorkflowStepItem" [value]="workflowStepDetails?.Data" selectionMode="single" scrollable="true" scrollWidth="100%" >                    
