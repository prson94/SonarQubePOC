...
@Component({
    ...
    template: `     
                    ...
                    <div style="padding:20px;" *ngIf="showHealthDetails || showIssueDetails || showBoardDetails">
                        ...
                        <d3s-object-board-details *ngIf="showBoardDetails" [objectType]="objectType" [objectID]="objectID" [objectName]="objectName" [daysToLookBack]="-1"></d3s-object-board-details>
                    </div>
                `,
    styles: [`
