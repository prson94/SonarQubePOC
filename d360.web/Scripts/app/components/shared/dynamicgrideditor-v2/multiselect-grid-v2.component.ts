...
export const MULTISELECT_GRID_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => MultiSelectGridComponentV2),
    multi: true
};

@Component({
    selector: 'd3s-multiselect-grid-v2',
    template: ` 
...
export class MultiSelectGridComponentV2 extends BaseComponent implements OnInit, ControlValueAccessor  {   
