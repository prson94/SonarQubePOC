...
@Component({
    ...
    template: `
                        ...
                        <ng-template pTemplate="body" let-item>
                            <tr (dblclick)="selected=item;editItemClick.emit(selected)" [pSelectableRow]="item">
                                <td *ngFor="let column of columns">
                                    <d3s-dynamic-field-value-v2 [column]="column" [fields]="fields"
                                                             [item]="item"></d3s-dynamic-field-value-v2>
                                </td>
                                <td>
        ...
        <d3s-dynamic-editor-v2 *ngIf="showEditor" [objectID]="objectID" [objectType]="objectType"
...
[objectTypeUid]="assetTypeUid" [isV2API]="useV2Api"></d3s-dynamic-editor-v2>
...
export class DynamicGridComponentV2 extends BaseComponent implements OnChanges {
