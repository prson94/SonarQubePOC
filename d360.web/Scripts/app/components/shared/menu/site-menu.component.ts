...
export class SiteMenuComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    private buildAdminMenu() {
        ...
        metaMenu.Items.push({ Name: 'Maps', Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_MAPS}`, Items: null, IsLink: false, IsHomePage: false });
        ...
        metaMenu.Items.push({ Name: 'Relationship Types', Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_RELATIONSHIPS}`, Items: null, IsLink: false, IsHomePage: false });
