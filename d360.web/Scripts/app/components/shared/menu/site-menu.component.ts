...
export class SiteMenuComponent extends BaseComponent implements OnInit, OnDestroy, AfterContentInit {
    ...
    buildConfigMenu() {
		...
		this.configMenu.NavigationItems.push({ Name: $localize`Diagram Assets`, Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET_DIAGRAM_ASSETS}`, Items: null, IsLink: false, count: null });
