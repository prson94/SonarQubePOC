...
export class SiteMenuComponent extends BaseComponent implements OnInit, OnDestroy, AfterContentInit {
    ...
    loadMenu() {
        ...
        this.siteMenuService.getMenu().subscribe(
            (result) => {
				...
				result.MenuItems = result.MenuItems.filter((x) => (x.MenuID !== '#Monitor'));					
                ...
                for (const menu of result.MenuItems) {
                    ...
                    switch (menu.MenuID) {
						...
						case '#Assignments':
							menu.NavigationItems = [];
							menu.ngUrl = SiteUrlHelpers.SITE_URL_ASSIGNMENTS_ROOT;
							break;
						case '#Requests':
							menu.NavigationItems = [];
							menu.ngUrl = SiteUrlHelpers.SITE_URL_REQUESTS_ROOT;
							break;
                        case '#SemanticTypes':
                            menu.NavigationItems = [];
    ...
    buildConfigMenu() {
        ...
        this.configMenu.NavigationItems.push({ Name: $localize`Models`, Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET_MODELS}`, Items: null, IsLink: false, count: null });
		this.configMenu.NavigationItems.push({ Name: $localize`Policies`, Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET_POLICIES}`, Items: null, IsLink: false, count: null });
		this.configMenu.NavigationItems.push({ Name: $localize`Rules`, Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET}/${SiteUrlHelpers.SITE_URL_ADMIN_ASSET_RULES}`, Items: null, IsLink: false, count: null });
    ...
    private buildAdminMenu() {
		...
		//if (this.newSecurityEnabledFeatureFlag) {
			securityMenu.Items.push({ Name: $localize`Roles and Policies`, Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_SECURITY}/roles`, Items: null, IsLink: false, count: null });
		//}
		//else {
