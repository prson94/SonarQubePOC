...
export class SiteMenuComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    buildConfigMenu() {
        ...
        this.configMenu.NavigationItems.push({ Name: 'Action Types', Items: null, Url: `${SiteUrlHelpers.SITE_URL_ADMIN_ROOT}/${SiteUrlHelpers.SITE_URL_ADMIN_ISSUE_TYPES}`, IsLink: false, IsHomePage: false, count: null });
    }
