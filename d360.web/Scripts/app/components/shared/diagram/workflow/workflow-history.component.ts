...
<p-dataTable #dt *ngIf="!isLoading" [value]="history" selectionMode="single" [rows]="5" [rowsPerPageOptions]="[5,10,15]" [paginator]="true" [pageLinks]="3">
    <p-footer *ngIf="dt.totalRecords"><d3s-grid-paging-info [totalRecords]="dt.totalRecords" [first]="dt.first" [rows]="dt.rows"></d3s-grid-paging-info></p-footer>    
    <p-column header="Started On" field="StartedOn" sortable="true">
        <ng-template pTemplate="body" let-item="rowData">
            {{item.StartedOn | date:'shortDate'}}
        </ng-template>
    </p-column>
    <p-column header="Completed On" field="CompletedOn" sortable="true">
        <ng-template pTemplate="body" let-item="rowData">
            {{item.CompletedOn | date:'shortDate'}}
        </ng-template>
    </p-column>
    <p-column header="Started By" field="StartedBy" sortable="true"></p-column>
