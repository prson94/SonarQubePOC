    ...
    template: `
                <div *ngIf="enabled" #actions class="header-action-container" (window:resize)="onResize($event)">
                    <ul class="header-actions-list">
                        ...
                        <li class="header-action-li hide-on-med-and-down" *ngIf="headerActionsService.showFavorite && !isAdminUrl && !isAdminSidebarUrl" ><d3s-header-favorites [uri]="uri" [favItems]="favItems" [homePageItem]="homePageItem"></d3s-header-favorites></li>
                        <li class="header-action-li hide-on-med-and-down" *ngIf="headerActionsService.showFavorite && !isAdminUrl && !isAdminSidebarUrl" ><d3s-header-homepage [uri]="uri" [homePageItem]="homePageItem"></d3s-header-homepage></li>
