    ...
    template: ` <span #item class="header-search header-table" [ngClass]="{'header-search-active':active}" (mouseenter)="show(item)" (mouseleave)="hide(item)">
                    ...
                    <div class="header-help search-child header-profile-panel">
                       <ul>
                            ...
                            <li class="header-item"><div class="mini-menu-line"><div class="text"><a target="_blank" (click)="popup(popupBox)">About Data360 Govern</a></div></div></li>
                       </ul>
                    </div>
                    <div #popupBox class="modal-overlay about" tabindex=-1 (keydown)="checkKey($event,popupBox)" >
                    <div class="modal-dialog">
                        <div class="title-bar">
                            <h1>About Data360 Govern</h1>
