...
@Component({
    ...
    template: ` 
                <div *ngIf="!inline && isLoading && !showTransparentLoader">
                    <div style="padding:10px;text-align:center;"><i class="fa fa-spinner fa-spin fa-2x"></i></div>
                    <span style="padding:10px;text-align:center;display: block;">
                        <ng-content></ng-content>
                    </span>
                </div>
                <div *ngIf="!inline && isLoading && showTransparentLoader" style="postion:relative;overflow:hidden;width100%;">
                ...
                <div *ngIf="inline && isLoading" style="postion:relative;overflow:hidden;width100%;">
