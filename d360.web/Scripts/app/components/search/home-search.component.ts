...
@Component({
    ...
    template: `               
                <d3s-hero-search-input (keydown.enter)="navigateSearch()" (search)="navigateSearch()" [(isExactMatch)]="isExactMatch" [(searchTypes)]="searchTypes" [(searchText)]="searchText"></d3s-hero-search-input>                
                `,
