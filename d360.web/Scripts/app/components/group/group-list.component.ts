                        ...
                        <div class="tile tile-detail" >    
                            <div class="row" *ngIf="!isLoading">                        
                                <div class="col s12">
                                    ...
                                    <p-table #dt [value]="groups" selectionMode="single" [metaKeySelection]="true" [globalFilterFields]="['Name','ID','NumberOfMembers']" sortField="Name" [pageLinks]="3" [paginator]="true" [rows]="defaultInitialItemsPerPage" [rowsPerPageOptions]="defaultPagingOptions" [(selection)]="selected">
                                        <ng-template pTemplate="header">
                                            ...
                                            <tr [hidden]="showSimpleFilter">
                                                ...
                                                <th><d3s-column-filter [field]="'NumberOfMembers'" [datatype]="'text'"></d3s-column-filter></th>
                                                <th></th>
                                            </tr>
                                        </ng-template>
