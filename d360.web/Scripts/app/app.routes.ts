...
const routes: Routes = [
	...
	{ path: "admin/relationships/:uid/details", data: { type: 'relationship' }, loadChildren: () => import("./components/admin/relationships/detail-page/relationship-type-detail-page.module").then((m) => m.RelationshipTypeDetailPageModule) },
