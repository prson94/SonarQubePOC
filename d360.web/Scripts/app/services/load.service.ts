...
export class LoadService extends BaseObservableService {
	...
	postLoad(model: LoadFilePostModel, triggerWorkflow: boolean): Observable<JsonResult> {
		return this.http.post('form/AddLoad?triggerWorkflow=' + triggerWorkflow, model).pipe(
