...
export class AssetTypeService extends BaseObservableService {
    ...
    GetAssetTypeByUid(uid: string): Observable<AssetTypeApiModel & ErrorResponse> {
        return this
            .http
			.get(`api/v2/assets/types?assetTypeUid=${uid}&includeSynonymAllocation=true&includeUpdatedAndCreatedFields=true&includedashboardflag=true&includeCustomExportTemplatesFlag=true`)
            .pipe(
