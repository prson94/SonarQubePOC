...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shared_grid_paging_info_component__ = __webpack_require__(1167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_dashboard_shared_dashboard_module__ = __webpack_require__(1283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_delete_form__ = __webpack_require__(1169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__model_routes__ = __webpack_require__(1457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__model_component__ = __webpack_require__(1339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__model_list_component__ = __webpack_require__(1338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__model_item_component__ = __webpack_require__(1337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__model_item_structure_component__ = __webpack_require__(1336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23_primeng_primeng__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23_primeng_primeng___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_23_primeng_primeng__);
/* harmony export (binding) */ __webpack_require__.d(exports, "ModelModule", function() { return ModelModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ModelModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                ...
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["e" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["RouterModule"],
                __WEBPACK_IMPORTED_MODULE_18__model_routes__["a" /* ModelRoutingModule */],
                //primeng
                __WEBPACK_IMPORTED_MODULE_23_primeng_primeng__["GrowlModule"],
                __WEBPACK_IMPORTED_MODULE_23_primeng_primeng__["InputTextModule"],
                ...
                __WEBPACK_IMPORTED_MODULE_23_primeng_primeng__["MultiSelectModule"],
                __WEBPACK_IMPORTED_MODULE_23_primeng_primeng__["TooltipModule"],
                __WEBPACK_IMPORTED_MODULE_23_primeng_primeng__["TreeModule"],
                ...
                __WEBPACK_IMPORTED_MODULE_11__shared_grid_paging_info_component__["a" /* SharedGridPagingInfoModule */],
                __WEBPACK_IMPORTED_MODULE_12__shared_dashboard_shared_dashboard_module__["a" /* SharedDashboardModule */],
                __WEBPACK_IMPORTED_MODULE_13__shared_delete_form__["a" /* SharedDeleteFormModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_19__model_component__["a" /* ModelComponent */],
                __WEBPACK_IMPORTED_MODULE_20__model_list_component__["a" /* ModelListComponent */],
                __WEBPACK_IMPORTED_MODULE_21__model_item_component__["a" /* ModelItemComponent */],
                __WEBPACK_IMPORTED_MODULE_22__model_item_structure_component__["a" /* ModelItemStructureComponent */],
            ],
            providers: [
                { provide: __WEBPACK_IMPORTED_MODULE_3__angular_http__["d" /* XHRBackend */], useClass: __WEBPACK_IMPORTED_MODULE_5__authentication_connection_backend__["a" /* AuthenticationConnectionBackend */] },
            ]
...
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return ModelItemStructureComponent; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var ModelItemStructureComponent = (function (_super) {
    __extends(ModelItemStructureComponent, _super);
    function ModelItemStructureComponent(headerActionsService, route, router, rightSidebarService, modelsService, titleService, messagesService, headerBreadcrumbService, permissionsService) {
    ...
    ModelItemStructureComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.params.subscribe(function (params) {
            _this.modelId = +params['modelId'];
            _this.loadPermissions(_this.permissionsService, __WEBPACK_IMPORTED_MODULE_7__static_string_constants__["a" /* StringConstants */].ObjectTaxonomyType, _this.modelId);
            _this.headerBreadcrumbService.setCurrentObjectInfo('TaxonomyType', _this.modelId);
            _this.isLoading = true;
            _this.modelsService.getModel(_this.modelId)
                .then(function (result) {
                _this.isLoading = false;
                _this.model = result;
                _this.headerBreadcrumbService.clearBreadcrumbs();
                _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */]('Models', __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_ROOT + "/" + __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_CLASSIFICATION));
                _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](_this.model.ClassificationName, __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_ROOT + "/" + __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_CLASSIFICATION + "/" + _this.model.ClassificationName));
                _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](_this.model.Name, __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('TAXONOMYTYPE', _this.model.ID)));
                _this.loadModelHierarchy(_this.modelId);
                _this.setBrowserTitle(_this.titleService, _this.model.Name);
            });
            _this.rightSub = _this.rightSidebarService.rightSidebarClicked$.subscribe(function (r) {
                if (r.tag == 'modeldiagram') {
                    _this.isModelDiagramVisible = !_this.isModelDiagramVisible;
                }
                else {
                    _this.isModelDiagramVisible = false;
                }
            });
        });
    };
    ModelItemStructureComponent.prototype.ngOnDestroy = function () {
        this.clearSidebar();
        this.sub.unsubscribe();
        this.rightSub.unsubscribe();
    };
    ModelItemStructureComponent.prototype.loadModelHierarchy = function (modelId) {
        var _this = this;
        this.modelsService.getModelHierarchy(modelId, true)
            .then(function (result) {
            _this.modelHierarchy = result;
            _this.treeNodeArray = _this.buildTreeNodeArray(_this.modelHierarchy);
        });
    };
    ModelItemStructureComponent.prototype.buildTreeNodeArray = function (models, Parent) {
    ...
    ModelItemStructureComponent.prototype.showHierarchy = function (id) {
        this.router.navigateByUrl(__WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('TAXONOMY', id, this.modelId));
    };
    ModelItemStructureComponent.prototype.setTreeNodeStyles = function (node) {
        if (!node.data)
            return null;
        var styles = {
    ...
    ModelItemStructureComponent.prototype.deleteModelHierarchy = function (id) {
        var _this = this;
        this.isLoading = true;
        this.modelsService.deleteModelHierarchy(id).then(function (res) {
            if (!res.isError) {
    ...
    ModelItemStructureComponent.prototype.deleteSelectedTreeNode = function (id) {
        var nodes = [];
        // add root nodes
    ...
    ModelItemStructureComponent.prototype.saveTaxonomy = function (event) {
        var _this = this;
        this.isLoading = true;
    ...
    ModelItemStructureComponent.prototype.closeEditor = function () {
        this.showEditor = false;
    };
    ModelItemStructureComponent.prototype.showAdd = function () {
        this.showEditor = true;
        this.selectedParentID = this.selected ? this.selected.data.id : undefined;
        this.selected = null;
    };
    ModelItemStructureComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'd3s-model-item-structure',
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */], __WEBPACK_IMPORTED_MODULE_4__services_index__["s" /* PermissionsService */]],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["o" /* HeaderActionsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["o" /* HeaderActionsService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["i" /* RightSidebarService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["i" /* RightSidebarService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["a" /* MessagesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["a" /* MessagesService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["s" /* PermissionsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["s" /* PermissionsService */]) === 'function' && _j) || Object])
    ], ModelItemStructureComponent);
    return ModelItemStructureComponent;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__static_string_constants__ = __webpack_require__(490);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return ModelItemComponent; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var ModelItemComponent = (function (_super) {
    __extends(ModelItemComponent, _super);
    function ModelItemComponent(route, router, rightSidebarService, modelsService, titleService, surveysService, headerBreadcrumbService, permissionsService) {
        _super.call(this, rightSidebarService);
        this.route = route;
        this.router = router;
        this.modelsService = modelsService;
    ...
    ModelItemComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.sub = this.route.params.subscribe(function (params) {
            ...
            var newModelId = +params['modelId'];
            var hierarchyId = +params['id']; // if hierarchyId is passed via alternative route to workaround bug with router escaping ; = and other chars.
            if (!hierarchyId)
                hierarchyId = params['hierarchyId'] ? +params['hierarchyId'] : 0;
            if (hierarchyId != 0)
                _this.headerBreadcrumbService.setCurrentObjectInfo('Taxonomy', hierarchyId);
            else
                _this.headerBreadcrumbService.setCurrentObjectInfo('TaxonomyType', newModelId);
            if (_this.modelId != newModelId) {
                _this.modelId = newModelId;
                _this.isLoading = true;
                ...
                _this.selectModelHierarchy(hierarchyId);
            }
        });
    };
    ModelItemComponent.prototype.ngOnDestroy = function () {
        this.clearSidebar();
        this.sub.unsubscribe();
        this.treeSub.unsubscribe();
    };
    ModelItemComponent.prototype.load = function (hierarchyId) {
        var _this = this;
        return this.modelsService.getModel(this.modelId)
            ...
            _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](_this.model.ClassificationName, __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_ROOT + "/" + __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_CLASSIFICATION + "/" + _this.model.ClassificationName));
            _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](_this.model.Name, __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('TAXONOMYTYPE', _this.model.ID)));
            _this.loadModelHierarchy(_this.modelId, hierarchyId);
            _this.setBrowserTitle(_this.titleService, _this.model.Name);
            _this.clearSidebar();
            _this.setCommonRightSideBar(true, true, _this.model.HasDashboards, true, true, true, true);
        });
    };
    ModelItemComponent.prototype.selectModelHierarchy = function (selectedHierarchyId) {
        if (selectedHierarchyId > 0) {
            var selArray = this.modelHierarchy.filter(function (x) { return x.ID == selectedHierarchyId; });
        ...
        this.loadPermissions(this.permissionsService, __WEBPACK_IMPORTED_MODULE_7__static_string_constants__["a" /* StringConstants */].ObjectTaxonomy, this.selected.ID);
        this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](this.selected.Name, undefined, true, 'Taxonomy', this.selected.ID, this.treeNodeArray, this.findSelectedTreeNode(selectedHierarchyId)));
    };
    ModelItemComponent.prototype.loadModelHierarchy = function (modelId, selectedHierarchyId) {
        var _this = this;
        this.modelsService.getModelHierarchy(modelId)
            .then(function (result) {
            _this.modelHierarchy = result;
            _this.treeNodeArray = _this.buildTreeNodeArray(_this.modelHierarchy);
            _this.selectModelHierarchy(selectedHierarchyId);
            _this.messages = []; //clear any messages for this model
            _this.loadItemSurvey(_this.modelId);
        });
    };
    ModelItemComponent.prototype.findSelectedTreeNode = function (id) {
        var nodes = [];
        // add root nodes
    ...
    ModelItemComponent.prototype.buildTreeNodeArray = function (models, Parent) {
        //find the root items then 
        var rootNodes = models.filter(function (x) { return (Parent != undefined ? x.ParentID == Parent : !x.ParentID); });
        if (rootNodes.length == 0)
            return null;
    ...
    ModelItemComponent.prototype.showHierarchy = function (id) {
        this.router.navigateByUrl(__WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('TAXONOMY', id, this.modelId));
    };
    ModelItemComponent.prototype.loadItemSurvey = function (modelId) {
        var _this = this;
        if (!this.selected) {
    ...
    ModelItemComponent.prototype.completeSurvey = function () {
        this.showSurvey = false;
        var index = this.messages.findIndex(function (x) { return x.data == 'Survey'; });
        if (index >= 0 && index < this.messages.length)
            this.messages.splice(index, 1);
    };
    ModelItemComponent.prototype.editComplete = function (e) {
        this.load(e.ID);
    };
    ModelItemComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'd3s-model-item',
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */], __WEBPACK_IMPORTED_MODULE_4__services_index__["r" /* SurveysService */], __WEBPACK_IMPORTED_MODULE_4__services_index__["s" /* PermissionsService */]],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["i" /* RightSidebarService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["i" /* RightSidebarService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["r" /* SurveysService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["r" /* SurveysService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["s" /* PermissionsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["s" /* PermissionsService */]) === 'function' && _h) || Object])
    ], ModelItemComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_lodash__);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return ModelListComponent; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var ModelListComponent = (function (_super) {
    __extends(ModelListComponent, _super);
    function ModelListComponent(route, router, rightSidebarService, titleService, headerBreadcrumbService, modelsService) {
        _super.call(this, rightSidebarService);
        this.route = route;
        this.router = router;
        this.titleService = titleService;
    ...
    ModelListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.params.subscribe(function (params) {
            _this.modelGroup = params['group'];
            _this.headerBreadcrumbService.clearCurrentObjectInfo();
            _this.headerBreadcrumbService.clearBreadcrumbs();
            _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */]('Models', _this.modelGroup ? __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_ROOT + "/" + __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_CLASSIFICATION : undefined));
            if (_this.modelGroup) {
                _this.headerBreadcrumbService.showBreadcrumb(new __WEBPACK_IMPORTED_MODULE_5__models_breadcrumb_model__["a" /* Breadcrumb */](_this.modelGroup));
            }
            _this.setBrowserTitle(_this.titleService, (_this.modelGroup ? _this.modelGroup + ' ' : '') + "Models");
            _this.loadModels();
        });
    };
    ...
    ModelListComponent.prototype.loadModels = function () {
        var _this = this;
        this.isLoading = true;
        this.modelsService.getModels()
            ...
            _this.isLoading = false;
            _this.models = result;
            _this.models = __WEBPACK_IMPORTED_MODULE_7_lodash__["sortBy"](_this.models, 'TaxonomyTypeClass');
            if (_this.models.length && _this.models.length > 0)
                _this.selected = _this.models[0];
        });
    };
    ModelListComponent.prototype.showModelType = function (model) {
        this.router.navigateByUrl(__WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('TAXONOMYTYPECLASS', 0, undefined, model.TaxonomyTypeClass));
    };
    ModelListComponent.prototype.showModel = function (model) {
        this.router.navigateByUrl(__WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].getObjectUrl('TAXONOMYTYPE', model.ID));
    };
    ModelListComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'd3s-model-list',
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */]],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["i" /* RightSidebarService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["i" /* RightSidebarService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["Title"]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["g" /* HeaderBreadcrumbService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_index__["O" /* ModelsService */]) === 'function' && _f) || Object])
    ], ModelListComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__model_component__ = __webpack_require__(1339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__model_list_component__ = __webpack_require__(1338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_item_component__ = __webpack_require__(1337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__model_item_structure_component__ = __webpack_require__(1336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__ = __webpack_require__(85);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return ModelRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__model_component__["a" /* ModelComponent */],
        children: [
            { path: __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_CLASSIFICATION + '/:group', component: __WEBPACK_IMPORTED_MODULE_3__model_list_component__["a" /* ModelListComponent */] },
            { path: __WEBPACK_IMPORTED_MODULE_6__static_site_url_helpers__["a" /* SiteUrlHelpers */].SITE_URL_MODEL_CLASSIFICATION, component: __WEBPACK_IMPORTED_MODULE_3__model_list_component__["a" /* ModelListComponent */] },
            { path: ':modelId/structure', component: __WEBPACK_IMPORTED_MODULE_5__model_item_structure_component__["a" /* ModelItemStructureComponent */] },
            { path: ':modelId', component: __WEBPACK_IMPORTED_MODULE_4__model_item_component__["a" /* ModelItemComponent */] },
            { path: ':modelId/id/:id', component: __WEBPACK_IMPORTED_MODULE_4__model_item_component__["a" /* ModelItemComponent */] }
        ]
    }
];
...
//# sourceMappingURL=modelChunk.map