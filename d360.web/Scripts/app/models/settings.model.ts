...
export module SettingsHelper {
    export function getSearchTypesList(): SearchType[] {
        return [
            ...
            { title: StringConstants.AssetTypeClass_Business, value: "BusinessAsset", selected: false },
            { title: StringConstants.AssetTypeClass_Technical, value: "TechnicalAsset", selected: false },
