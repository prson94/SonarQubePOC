    ...
    public class BasicAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
         ...
         //   UserManager<IdentityUser> usermanager = CreateUserManager();
            CompanyContext company = CreateCompanyContext();
            CommunityContext community = CreateCommunityContext();

            var hash = community.CurrentCompanySsoModel.HashAlgorithmType;
            ...
            // for test say everyone who passed basic creds is bob..
            principal = new GenericPrincipal(new GenericIdentity("bob"), null);
        ...
        private static CompanyContext CreateCompanyContext()
        {
            ...
            CompanyContext context = resolver.GetService(typeof(CompanyContext)) as CompanyContext;

            return context;
        }

        private static CommunityContext CreateCommunityContext()
        {
            var resolver = System.Web.Mvc.DependencyResolver.Current;

            CommunityContext context = resolver.GetService(typeof(CommunityContext)) as CommunityContext;
