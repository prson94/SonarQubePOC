...
namespace d360.web
{
	public static class WebApiConfig
	{
		public static void Register(HttpConfiguration config)
		{
			...
			config.Services.Add(typeof(IExceptionLogger), new ApplicationExceptionLogger());
			...
			config.AddApiVersioning(o =>
			{
				...
				o.ApiVersionSelector = new CurrentImplementationApiVersionSelector(new ApiVersioningOptions
				{
...
For general API usage and instructions please see the <a href='{HelpBaseUri}' target='_blank'>API documentation in the Govern Help</a>.";
					...
					{
						desc +=
							"<br><br><b>The Govern v1 API has been deprecated and will not be supported in a future release.&nbsp;&nbsp;Please use the improved v2 API where possible.</b>";
					}
			...
			config.EnableSwagger(c =>
			{
				...
				c.ApiKey("ApiKey").Description("API Key Authentication (i.e.   KEY;SECRET)").Name("Authorization").In("header");
				c.IncludeXmlComments($@"{AppDomain.CurrentDomain.BaseDirectory}\App_Data\Documentation.XML");
				c.DescribeAllEnumsAsStrings();
			}).EnableSwaggerUi(c =>
			{
