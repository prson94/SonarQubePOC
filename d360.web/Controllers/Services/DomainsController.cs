...
namespace d360.web.Controllers.Services
{
    ...
    public class DomainsController : BaseApiController
    {
        ...
        {
            var sql = @"select x.ID, x.HouseDomainItemID, x.DomainItemID, d1.Code as HouseCode, d2.Code as Code, d.Name as ListName, l.id as LanguageID, l.Name as LanguageName from domainitemxref x
        ...
        {
            var sql = @"select d2.ID, d2.Name as List from domain d
                        ...
                        where d.id = @id
                        union
                        select d2.ID, d2.Name as List from domain d
                        join domainitem di on di.domainid = d.id
        ...
        [Route("lists/domains"), HttpGet]
        public IQueryable<Domain> GetXrefDomains()
        {
            return Company.Filter<Domain>(i => i.DomainClassificationID == 3);
        }
    }
}
