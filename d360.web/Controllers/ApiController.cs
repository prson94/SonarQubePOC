        ...
        private void loadComplexLookupJoin(string type, int id, List<FieldTypeComplexLookupDefinitionRelation> joins, int i, out string objectCol, out string idCol)
        {
            ...
            switch (join.RelationType)
            {
                case ComplexLookupRelationType.StandardRelationhip:
                    ...
                    switch (join.Direction)
                    {
                        case FieldTypeComplexLookupRelationDirection.Back:
                            join.JoinStatement = (i == 0) ? 
                                $"from [Intersect] I{i}" : 
                                $"{joinType} join [Intersect] I{i} on I{i}.IntersectTypeID = {join.IntersectTypeID} and I{i}.[State] = 1 and (I{i}.Deleted = 0 or I{i}.Deleted is null) and I{i}.Object = '{previousObj}' and I{i}.ObjectID = A{i - 1}.{previousObjIdColumn}";
                            break;
                        case FieldTypeComplexLookupRelationDirection.Forward:
                            join.JoinStatement = (i == 0) ? 
                                $"from [Intersect] I{i}" : 
                                $"{joinType} join [Intersect] I{i} on I{i}.IntersectTypeID = {join.IntersectTypeID} and I{i}.[State] = 1 and (I{i}.Deleted = 0 or I{i}.Deleted is null) and I{i}.Subject = '{previousObj}' and I{i}.SubjectID = A{i - 1}.{previousObjIdColumn}";
                            break;
                        default:
                            join.JoinStatement = (i == 0) ? 
                                $"from [Intersect] I{i}" : 
                                $"{joinType} join [Intersect] I{i} on I{i}.IntersectTypeID = {join.IntersectTypeID} and I{i}.[State] = 1 and (I{i}.Deleted = 0 or I{i}.Deleted is null) and ( (I{i}.Subject = '{previousObj}' and I{i}.SubjectID = A{i - 1}.{previousObjIdColumn}) OR (I{i}.Object = '{previousObj}' and I{i}.ObjectID = A{i - 1}.{previousObjIdColumn} ) )";
                            break;
                    }
                    ...
                    if (i == 0)
                    {
                        switch (join.Direction)
                        {
                            case FieldTypeComplexLookupRelationDirection.Back:
                                ...
                                join.WhereStatement = $"I{i}.IntersectTypeID = {join.IntersectTypeID} and I{i}.[State] = 1 and (I{i}.Deleted = 0 or I{i}.Deleted is null) and I{i}.Object = '{type}' and I{i}.ObjectID = {id}";
                            ...
                            case FieldTypeComplexLookupRelationDirection.Forward:
                                ...
                                join.WhereStatement = $"I{i}.IntersectTypeID = {join.IntersectTypeID} and I{i}.[State] = 1 and (I{i}.Deleted = 0 or I{i}.Deleted is null) and I{i}.Subject = '{type}' and I{i}.SubjectID = {id}";
                            ...
                            default:
                                ...
                                join.WhereStatement = $"I{i}.IntersectTypeID = {join.IntersectTypeID} and I{i}.[State] = 1 and (I{i}.Deleted = 0 or I{i}.Deleted is null) and ( (I{i}.Subject = '{type}' and I{i}.SubjectID = {id}) OR (I{i}.Object = '{type}' and I{i}.ObjectID = {id} ) )";
                    ...
                    if (addDeletedCheck)
                    {
                        join.JoinStatement += $" and I{i}.[State] = 1 and (A{i}.Deleted = 0 OR A{i}.Deleted is null)";
                    }
                    break;
                #endregion
                case ComplexLookupRelationType.ChildRelationship:
                    ...
                    if (addDeletedCheck)
                    {
                        join.JoinStatement += $" and I{i}.[State] = 1 and A{i}.Deleted = 0";
                    }
                    join.WhereStatement += string.IsNullOrEmpty(join.WhereStatement) ? permissionsWhere : (string.IsNullOrEmpty(permissionsWhere) ? "" : $" and {permissionsWhere}");
                    break;
                #endregion
