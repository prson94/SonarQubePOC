...
for json path, WITHOUT_ARRAY_WRAPPER";
        ...
        public async Task<IHttpActionResult> PutFieldTypesAsync(FieldTypesApiEditModel model)
        {
            ...
            try
            {
                ...
                {
                    actionTypeIdentifierInfoModels = await Company.QueryAsync<TypeIdentifierInfoModel>("select ID, Uid, 'IssueType' as Object, ID as ObjectID from IssueType where Uid = @uid", new { uid = model.ActionTypeUid.Value });
                ...
                {
                    assetTypeIdentifierInfoModels = await Company.QueryAsync<TypeIdentifierInfoModel>("select ID, Uid, Object, ObjectID from AssetType where Uid = @uid", new { uid = model.AssetTypeUid.Value });
                ...
                {
                    relationshipTypeIdentifierInfoModels = await Company.QueryAsync<TypeIdentifierInfoModel>("select ID, Uid, 'IntersectType' as Object, ID as ObjectID from IntersectType where Uid = @uid", new { uid = model.RelationshipTypeUid.Value });
                ...
                ValidateModel(model, actionTypeIdentifierInfoModel, assetTypeIdentifierInfoModel, relationshipTypeIdentifierInfoModel);
                ...
                UpdateFields(model, typeIdentifierInfoModel);
        ...
        private static void ValidateModel(FieldTypesApiEditModel model, TypeIdentifierInfoModel actionTypeIdentifierInfoModel, TypeIdentifierInfoModel assetTypeIdentifierInfoModel, TypeIdentifierInfoModel relationshipTypeIdentifierInfoModel)
        {
            if (model == null)
            {
        ...
        private void UpdateFields(FieldTypesApiEditModel model, TypeIdentifierInfoModel typeIdentifierInfoModel)
        {
