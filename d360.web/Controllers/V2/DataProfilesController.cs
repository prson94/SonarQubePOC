...
namespace d360.web.Controllers.V2
{
    ...
    public class DataProfilesController : BaseV2ApiController
    {
        ...
        [
            ...
            SwaggerParameter("_filter", "The filter expression used to filter assets by path, assetTypePath fields and/or when the . Asterisk (*) symbol can be used as a wild card character to match any character.", DataType = "string", ParameterType = "query", Required = false),
