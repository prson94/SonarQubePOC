...
namespace d360.web.Controllers.V2
{
    ...
    public class PermissionsController : BaseV2ApiController
    {
        ...
        {
            if(new[] { AssetTypeClass.Generic, AssetTypeClass.Fusion, AssetTypeClass.FusionAttribute, AssetTypeClass.AttributeGroup, AssetTypeClass.Organization, AssetTypeClass.User, AssetTypeClass.Group, AssetTypeClass.FusionQuery }.Contains(assetTypeClass))
            {
                return false;
            }
            else
