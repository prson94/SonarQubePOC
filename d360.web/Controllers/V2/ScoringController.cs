...
namespace d360.web.Controllers.V2
{
    ...
    public class ScoringController : BaseV2ApiController
    {
        ...
        public ScoringController(ICoreComponentSet set, IQueueSource queueSource, IScoringRepository scoringRepository, IAssetRepository assetRepository, IMetricsRepository metricsRepository)
            : base(set)
        {
        ...
        /// </summary>
        /// <param name="Class">Allows for filtering the allocations by asset type class. The Organization, User, Group, Reference, Diagram, Generic and ReferenceItemType class types are not applicable for scoring.</param>
