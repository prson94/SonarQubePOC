...
namespace d360.web.Controllers.V2
{
	...
	public class ResponsibilitiesController : BaseV2ApiController
	{
		...
		public IHttpActionResult DeleteResponsibilitiesOverride(Guid assetUid, Guid responsibilityUid, [FromBody] List<ResponsibilityOverrideDeleteModel> resourceUids, bool passedResponsibilityCheck = false)
		{
			var asset = AssetRepository.GetAssetByUID(assetUid);
