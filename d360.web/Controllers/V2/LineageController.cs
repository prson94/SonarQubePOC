...
namespace d360.web.Controllers.V2
{
    ...
    [
        ApiVersion("2.0"),
        RoutePrefix("api/v{version:apiVersion}/lineage"),
        Authorize,
        ApiExplorerSettings(IgnoreApi = true)
    ]
    public class LineageController : BaseV2ApiController
    {
        public LineageController(ICommunityContext community, ICompanyContext company) : base(community, company)
        {
        }
