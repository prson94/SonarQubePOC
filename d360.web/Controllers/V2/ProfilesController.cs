        ...
        public async Task<IHttpActionResult> InsertDataProfile(List<AssetDataProfileViewModel> model)
        {
            ...
            try
            {
                ...
                foreach (var profile in model)
                {
                    ...
                    row["AssetId"] = 0;
                    row["RowCount"] = (object)profile.RowCount ?? DBNull.Value;
                    row["Uniqueness"] = (object)profile.Uniqueness ?? DBNull.Value;
                    row["UniqueCount"] = (object)profile.UniqueCount ?? DBNull.Value;
                    row["Completeness"] = (object)profile.Completeness ?? DBNull.Value;
                    row["NullCount"] = (object)profile.NullCount ?? DBNull.Value;
                    row["BlankCount"] = (object)profile.BlankCount ?? DBNull.Value;
