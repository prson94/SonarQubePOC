...
namespace d360.web.Controllers.V2
{
    ...
    public class MetricsController : BaseV2ApiController
    {
        ...
        [
            ...
            SwaggerParameter("_isFriendlyNameExport", "Additional parameter that can be supplied when doing a file export. If provided response file will replicate format of Result List screen", DataType = "date-time", ParameterType = "query", Required = false),            
