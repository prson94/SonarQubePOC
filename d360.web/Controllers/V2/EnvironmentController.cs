	...
	public class EnvironmentController : BaseV2ApiController
	{
		...
		public HttpResponseMessage GetAppSettings()
		{
			try
			{
				...
				{
					new ApplicationSetting { Name = "HelpBaseUri", Value = Config.GetValue<string>("HelpBaseUri") },
		...
		private const string THEME_UID_FILTER_PARAMETER = "An optional unique identifier of the theme, to limit this list to a specific theme.";
		private const string THEME_NOT_FOUND = "The theme was not found based on the provided unique identifier.";
