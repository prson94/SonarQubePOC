...
namespace d360.web.Controllers.V2
{
    ...
    public class AssetsController : BaseV2ApiController
    {
        ...
        [
            ...
            SwaggerParameter("_excludeCount", "If the value is True, the results will exclude count query. The default value is False.", DataType = "boolean", ParameterType = "query", Required = false),
        ]
