...
namespace d360.web.Controllers.V2
{
    ...
    public class AssetsController : BaseV2ApiController
    {
        ...
        [
            ...
            SwaggerParameter("_includeParent", "If the value is True ParentUID and ParentDisplayName will be added to reponse. Defaults to False.", DataType = "boolean", ParameterType = "query", Required = false),
        ]
