...
");
        ...
        public async Task<IHttpActionResult> PostBulkAssetsV2Async(Guid uid)
        {
            ...
            try
            {
                ...
                var results = (Company.Database.Connection as SqlConnection).BulkAssetsImport(Company.CurrentResourceID, assetType, import);
