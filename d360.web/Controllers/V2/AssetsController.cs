...
namespace d360.web.Controllers.V2
{
    ...
    public class AssetsController : BaseV2ApiController
    {
        ...
        [
            ...
            Route("types"),
            SwaggerConsumes("application/json", "application/xml"), SwaggerProduces("application/json", "application/xml"),
            SwaggerParameter("UseAsTransformation", "Filter results by Use As Transformation setting. This value us used for Technical assets only to mark them as transformational type used in the asset.", DataType = "boolean", ParameterType = "query", Required = false),
            ...
            SwaggerParameter("AutoDisplayDescription", "Filter results by Auto Display Description setting. This value is used by the Govern UI to have the Description shown ont he asset list page by default or not.", DataType = "boolean", ParameterType = "query", Required = false),
